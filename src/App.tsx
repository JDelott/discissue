    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              <a href="#features" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">
                Features
              </a>
              <a href="#how-it-works" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">
                How It Works
              </a>
              <a href="#about" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors">
                About
              </a>
            </nav>
      ...
      <section id="features" className="py-16 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-8 shadow-soft hover:shadow-lg transition-shadow">
              <div className="h-12 w-12 rounded-md bg-primary-100 dark:bg-primary-900 flex items-center justify-center text-primary-600 dark:text-primary-300 mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">AI-Powered Conversion</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Smart conversion of conversations into structured issues with automatic tagging and categorization.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-8 shadow-soft hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Works directly with your Discord server and GitHub repositories with minimal setup required.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-8 shadow-soft hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Customizable Templates</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Define your own issue templates and conversion rules to match your team's workflow.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-600 to-secondary-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8">
            <button className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-md text-primary-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary-600 focus:ring-white transition-colors">
              Join Waitlist
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="mt-4 text-gray-400">
                Bridging the gap between Discord conversations and GitHub issues.
              </p>
            </div>
            <div>
